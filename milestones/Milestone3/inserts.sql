...
INSERT INTO Student (student_id, first_name, last_name, email, assigned_animal, room, advisor, monitor, gpa, city) VALUES (1, 'Jake', 'Pan', 'aa@mail.com', 1, 1, 1, 2, 2.0, 3), (2, 'Lisa', 'Who', 'lisa123@university.edu.mail.com', 1, 2, null, 3, 3.0, 2), (3, 'Alice', 'Moon', 'Alice@university.edu.mail.com', 1, 2, null, 3, 4.0, 1);
...
INSERT INTO School_Program (program_id, department, name) VALUES ( 1, 1, 'MATH HELP'), ( 2, 2, 'Hackathon'), ( 3, 2, 'COMPUTER TUTORING'), ( 4, NULL, 'Financial Help');
...
INSERT INTO Payment (payment_id, amount, student) VALUES (1, 52.50, 1), (2, 532.50, 2), (3, 412.50, 3);
 	-- For Bank_Account
INSERT INTO Payment (payment_id, amount, student) VALUES (4, 9000, 1), (5, 1400, 2), (6, 7468.50, 3);
...
-- Inserts for more data for Bot to use
INSERT INTO Student(student_id, first_name, last_name, email, assigned_animal, advisor, gpa, city) VALUES (9487, 'Sage', 'Jam', 'jam@mail.com', 0, 1, 3.3, 1), (9488, 'Sega', 'Man', 'Man@mail.com', 0, 2, 3.5, 3);
INSERT INTO Minor (student, department) VALUES (9487, 1), (9488, 3);
INSERT INTO Waitlist (waitlist_id, student, course) VALUES (4, 9487, 2), (5, 9488, 3);
INSERT INTO Sign_Up	(student, mailing_list) VALUES (9487, 2), (9488, 2);
 
#Find the all the Bank Account Payments made that are greater than the total average sales of credit Card Payments
INSERT INTO Payment (payment_id, amount, student) VALUES (7, 50, 9487), (8, 300, 9487), (9, 400, 9488);
INSERT INTO Bank_Account (payment, bank_account_number) VALUES (7, 894000025), (8, 781401413), (9, 091778899);
 
#Find all the School Programs that belong to the same Departments that a Student is Majoring in.
INSERT INTO Student(student_id, first_name, last_name, email, assigned_animal, gpa, monitor, city) VALUES (9489, 'Rusty', 'Burns', 'Burns@mail.uni.edu', 1, 3.49, 2, 1), (9490, 'Will', 'Silva', 'Silva@mail.uni.edu', 1, 3.91, 3, 2), (9491, 'Ellen', 'Snyder', 'Man@mail.uni.edu', 1, 3.25, 2, 3);
INSERT INTO Major (student, department) VALUES (9489, 1), (9490, 2), (9491, 3);
INSERT INTO School_Program (program_id, department, name) VALUES ( 5, 3, 'SCI PHY'), ( 6, 3, 'PHYSICS TUTORING'), ( 7, 1, 'PIE');
 
#Find all the Courses where an Author of its required Books is also teaching the Course
INSERT INTO Author (author_id, first_name, last_name, age) VALUES (4, 'Jack', 'Burke', 26), (5, 'Thomas', 'Garcia', 41);
INSERT INTO Faculty_Member (faculty_id, first_name, last_name, email, first_joined) VALUES (10, 'Jack', 'Burke', 'Burke@university.edu.mail.com', CURRENT_TIMESTAMP), (11, 'Thomas', 'Garcia', 'Garcia@university.edu.mail.com', CURRENT_TIMESTAMP);
INSERT INTO Book (book_id, book_isbn, title, publisher, publish_date, category) VALUES (4, '7460134782745', 'How to Scam', 'Me Inc.', '2021-08-01 00:14:00.742000000', 'Making Money'), (5, '4237824681', 'Totally Needed Book', 'Uni Inc.', '2021-06-04 00:28:00.742000000', 'Maths');
INSERT INTO Writes (writes_id, author, book) VALUES (4, 4, 5), (5, 5, 4);
INSERT INTO Professor (professor_id, faculty, years_taught) VALUES (4, 10, 2);
INSERT INTO Lecturer (lecturer_id, faculty, years_taught) VALUES (4, 11, 1);
INSERT INTO Time_Slot (time_slot_id, start_time, end_time) VALUES (4, '2021-04-03 04:14:00.742000000','2021-04-03 06:14:00.742000000'), (5, '2021-03-04 05:15:00.742000000','2021-03-04 05:15:00.742000000');
INSERT INTO Course (course_id, title, section, time_slot, classroom, city) VALUES (7, 'CSC211', 1, 4, 1, 1),  (8, 'PHY210', 2, 5, 2, 2);
INSERT INTO Requires (course, book) VALUES (7, 7460134782745), (8, 4237824681);
INSERT INTO Professor_Course (professor, course) VALUES (4, 8);
INSERT INTO Lecturer_Course (lecturer, course) VALUES (4, 7);

#Find the Resource Links and Required Books for each course


#Find all Students that are being monitored by a certain Faculty Member and are researching a certain Animal.
INSERT INTO Research (research_id, student, animal) VALUES (4, 9489, 1), (5, 9490, 3), (6, 9491, 2);
